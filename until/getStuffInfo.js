...
// 随机生成性别
 getSex: function(){
	var sexNumber = parseInt(2 * Math.random());
	var sex;
	sexNumber === 1 ? sex = '男' : sex = '女';
	return sex;
},
// 随机生成邮箱
getEmail:function (){
	...
	[
		...
		'@live.com','@qq.com','@0355.net',
		'@163.com','@163.net','@263.net',
		'@3721.net','@yeah.net','@googlemail.com'
		,'@mail.com'
	]
	var emailId = parseInt(Math.random()*16);
	var emailSufix = emailArray[emailId];
	var emailPrefix = ''
	for (let i=0;i<size;i++) {
		var j = Math.floor(Math.random() * seed.length);
		emailPrefix += seed[j];
	}
	var email = emailPrefix + emailSufix;
	return email;
},
// 随机生成密码
 randomPassword: function()
{
  ...
  var size = parseInt(Math.random()*6 + 4);
...
// 随机生成职业ID
 getProfessionalId:function(){
	...
	const professionalId = array[random];
...
// 随机生成职位ID
 getPositionID:function(){
	...
	'1200004','1200005','1200006',
	'1200007','1200008','1200009',
	'1200010','1200011','1200012',
	'1200013','1200014','1200015',
	]
	const random = parseInt(Math.random() * 15);
	const positionId = array[random];
	return positionId;
},
// 随机生成部门Id
 getDepartmentId:function(){
	...
	const departmentId = array[random];
	return departmentId;
},
...
// 随机生成身份证号码
 getId_no:function(){
	...
	var lastNumberArray = [ "1","0","X","9","8","7","6","5","4","3","2"];// 校验码
	 // 住址
	var addressArr = [
	"420101","980101","130101",
	"330101","890101","160101",
	"250101","513001","220101",
	"670101","510101","580101",
	];
	...
	var addressRandom = parseInt(Math.random()*12);
	var address = addressArr[addressRandom];
	var yearRandom = parseInt(Math.random() * 12);
	var year =  yearArr[yearRandom];
	var monthRandom = parseInt(Math.random() * 12);
	var month = monthArr[monthRandom];
	var dayRandom = parseInt(Math.random()* 28);
	var day = dayArr[dayRandom];
	var birthday = year + month + day; // 生日
...
// 随机生成地址
 getAddress:function(){
    ...
    function getArea(province,city){
   	...
   	const provinceArr = getProvince();
   	const provinceRandom = parseInt(Math.random() * provinceArr.length);
   	const province = provinceArr[provinceRandom];

   	const cityArr = getCity(province);
   	const cityRandom = parseInt(Math.random() * cityArr.length);
   	const city = cityArr[cityRandom];

   	const areaAyy = getArea(province, city);
   	const areaRandom = parseInt(Math.random() * areaAyy.length);
   	const area = areaAyy[areaRandom];
